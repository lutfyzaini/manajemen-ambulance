...
<body>
    ...
    <div class="form-input">
        ...
        <form method="post" action="armada.php">
            ...
            <input type="text" name="nama" value="<?=$editData ['nama_armada']?>" required><br><br>

            <label>Plat :</label>
            <input type="text" name="plat" required value="<?= $editData['plat']?>"><br><br>
            
            <label>Status :</label>
            <input type="text" name="status" required value="<?= $editData['status'] ?>"><br><br>
